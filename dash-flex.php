	      ...
	      <div class="container-fluid">
	      	<div class="row">
	      		<div class="col-xl-2 col-lg-3  sidebar fixed-top" >
	      			<div class="py-3 info">
	      				<a href="index.html">
	      			<img class="ms-3 me-2" src="images/logo white bg transparent 2.png" style="width:60px;height: 60px;">
	      				</a>
	      			<a class="navbar-brand title1 text-white my-3 fs-3" href="index.html">Anubis Century</a>
	      			</div>	
	      			<div class="border-bottom d-block"></div>      			
	      			<div class="admin-info border-bottom py-3 px-5">
	      				<img src="images/<?php echo $_SESSION['user_array']['image']; ?>" class="mx-3" style="width: 50px; height: 50px; border-radius:50%;" >
	      				<a class="font-creep text-white fs-3 title2"><?php echo $_SESSION['user_array']['name']; ?></a>
	      			</div>
